...
as a start point,
therefore it behaves different from other Visual mode.
...
e.g.) Enable only for MAIL.
    ...
    <item>
      ...
      <appendix>  &lt;replacementname&gt;VIM_EMU_ONLY_APPS&lt;/replacementname&gt;</appendix>
      <appendix>  &lt;replacementvalue&gt;MAIL&lt;/replacementvalue&gt;</appendix>
      <appendix>&lt;/replacementdef&gt;</appendix>
      <appendix>&lt;replacementdef&gt;</appendix>
      <appendix>  &lt;replacementname&gt;VIM_EMU_IGNORE_APPS&lt;/replacementname&gt;</appendix>
      <appendix>  &lt;replacementvalue&gt;&lt;/replacementvalue&gt;</appendix>
      <appendix>&lt;/replacementdef&gt;</appendix>
    </item>
...
|Command Mode|Can be used for saving file/exiting.|

An initial state is `Insert Mode`, then `Esc` or `Ctrl-[` bring you to the normal mode.
...
Ctrl-h to skip, ESC/Ctrl-[ to choose a candidate.
...
|Ctrl-a/Ctrl-e| To the binning/last of the line (emacs like).|
|w/W/e/E| Move a word forard (w/W: the beginning of the word, e/E: the end of the word).|
|b/B| Move a word backword (b/B:  the beginning of the word).|
